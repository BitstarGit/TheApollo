        ...
        if ($id !== $ask->user->id) {
            ...
            if (!empty($_FILES['media']['tmp_name'])) {
                ...
                $data = array(
                    ...
                    'errors'         => array(
                    'error_id'   => '3',
                    'error_text' => 'Bad Request, Invalid  ID or missing parameter'
                )
                );
            }
            ...
            if ($insert) {
                ...
                $data = array(
                    ...
                    $data       = array(
                        ...
                        'errors'         => array(
                            'error_id'   => '2',
                            'error_text' => 'Fatal Error message not sent'
                        )
                    );
                }
        }
...
if ($option == 'fetch') {
    ...
    $messages_html = [];
    $messages_html = GetMessagesApp($_POST['id'], ['last_id' => $_POST['last_id'], 'first_id' => $_POST['first_id'], 'return_method' => 'html']);
