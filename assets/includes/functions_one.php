...
function UserData($user_id = 0, $options = array()) {
    global $db, $ask, $lang, $countries_name;
...
function GetQuestions($data = array('page' => 'home', 'filter_by' => 'all', 'after_post_id' => 0, 'ids' => array(),'limit' => 5)){
    ...
    $query_text .= $orderby_text . $limit_text;
